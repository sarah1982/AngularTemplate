...
@Component({
  ...
  styleUrls: ['./tabbedpage.component.css']
})
export class TabbedpageComponent implements OnInit {
tabText=`Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
...
tabSecondText=`Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a 
...
from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source.
 Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This 
...
`
  ...
  ngOnInit() {
    document.getElementById('listmob').style.backgroundColor='#00BFFF';
  }

  colorActiveTab(item:string){
    if(item==='mob'){
      document.getElementById('listmob').style.backgroundColor='#00BFFF';
      document.getElementById('listui').style.backgroundColor="#fff";
      document.getElementById('listweb').style.backgroundColor='#fff';
    }else if(item==='ui'){
      document.getElementById('listui').style.backgroundColor='#00BFFF';
      document.getElementById('listmob').style.backgroundColor="#fff";
      document.getElementById('listweb').style.backgroundColor='#fff';
    }else if(item==='web'){
      document.getElementById('listweb').style.backgroundColor='#00BFFF';
      document.getElementById('listui').style.backgroundColor="#fff";
      document.getElementById('listmob').style.backgroundColor='#fff';
    }
  }
